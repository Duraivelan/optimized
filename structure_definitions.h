...
struct ParticleData
{
  ...
  mtrx1111D friction_tnsr_11x11_sqrt;
...
*/
    vctr4D result;
    result.comp[0] = - quat.comp[1] * theta.comp[x] - quat.comp[2] * theta.comp[y] - quat.comp[3] * theta.comp[z]; // + quat.comp[0] * 0.
