...
const double shear_rate =0.1;
const mtrx3D shear_rate_dt({0,0,0},{shear_rate*dt,0,0},{0,0,0}); // reference Thesis : Dynamics of Semi-Flexible Fibres in Viscous Flow; Samantha Mary Harris
